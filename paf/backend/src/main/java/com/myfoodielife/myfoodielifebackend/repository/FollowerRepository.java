package com.myfoodielife.myfoodielifebackend.repository;


import com.myfoodielife.myfoodielifebackend.entity.Followers;
...
public interface FollowerRepository extends JpaRepository<Followers, Integer> {
    @Query("SELECT " +
            "    new com.myfoodielife.myfoodielifebackend.entity.User(u.id, u.firstName, u.lastName) " +
            "FROM " +
            "    user u " +
            "INNER JOIN " +
