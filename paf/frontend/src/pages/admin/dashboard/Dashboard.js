    ...
    <div className="dashboard-wrapper">
      <div className="dashboard-content-wrapper">
        ...
        <CardContent sx={{ marginTop: "2em" }}>
          <Button sx={{ textTransform: "capitalize", color: "#eb5824" }}>
            View Profiles
          </Button>
          {/* Show comments list */}
          {allUsers.length > 0 ? (
        ...
        <CardContent sx={{ marginTop: "2em" }}>
          <Button
            sx={{ textTransform: "capitalize", color: "#eb5824" }}
      ...
      <Dialog open={open} onClose={handleClose} sx={{ zIndex: 1000 }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <DialogActions>
            ...
            {addOrEditAdmin.addOrEdit === "edit" ? (
              <div>
                <Button sx={{ color: "#eb5824" }} type="submit" name="update">
                  Update
                </Button>
              </div>
            ) : (
              <div>
                <Button sx={{ color: "#eb5824" }} type="submit" name="add">
                  Add
                </Button>
              </div>
            )}
